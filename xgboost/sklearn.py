...
class XGBModel(XGBModelBase):
    ...
    ''' BEGIN CHANGES '''
    # Note that no changes were made to objective in __init__()
    # Changing the objective parameter here made no difference -- perhaps
    # it is overridden in child classes
    ''' END CHANGES '''

    def __init__(self, max_depth=3, learning_rate=0.1, n_estimators=100,
                 verbosity=1, silent=None, objective="reg:squarederror", booster='gbtree',
...
class XGBClassifier(XGBModel, XGBClassifierBase):
    ...
    ''' BEGIN CHANGES '''
    # Only changes: objective=fobj vs objective="binary:logistic", in __init__()
    # No change to super __init__()
    def __init__(self, max_depth=3, learning_rate=0.1, n_estimators=100,
                 verbosity=1, silent=None,
                 objective=fobj, booster='gbtree',
...
class XGBRFClassifier(XGBClassifier):
    ...
    def __init__(self, max_depth=3, learning_rate=1, n_estimators=100,
                 verbosity=1, silent=None,
                 objective=fobj, n_jobs=1, nthread=None, gamma=0,
...
class XGBRFRegressor(XGBRegressor):
    ...
    ''' BEGIN CHANGES '''
    # Only changes: objective=fobj vs objective="reg:squarederror", in __init__()
    # No change to super __init__()
    def __init__(self, max_depth=3, learning_rate=1, n_estimators=100,
                 verbosity=1, silent=None,
                 objective=fobj, n_jobs=1, nthread=None, gamma=0,
...
class XGBRanker(XGBModel):
    ...
    ''' BEGIN CHANGES '''
    # Note that no changes were made to objective in __init__()
    # Ranking is a more complex problem that may require special changes
    # not necessary in the previous functions
    ''' END CHANGES '''
